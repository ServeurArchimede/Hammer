...
execute if entity @s[scores={HHSquare=1}] run function hammerhead:pickbreakx
execute if entity @s[scores={HHSquare=2}] run function hammerhead:pickbreakz
execute if entity @s[scores={HHSquare=3}] run function hammerhead:pickbreaky