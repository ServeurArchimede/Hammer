...
execute as @a[scores={HHUseNpick=1}] run function hammerhead:tagstone
...
execute as @a[scores={HHUseNshovel=1}] run function hammerhead:tagdirt
scoreboard players set @a[scores={HHUseDpick=1..}] HHUseDpick 0
scoreboard players set @a[scores={HHUseIpick=1..}] HHUseIpick 0
scoreboard players set @a[scores={HHUseNpick=1..}] HHUseNpick 0
...
scoreboard players set @a[scores={HHUseNshovel=1..}] HHUseNshovel 0
